...
// RecipeListItem.
export function filterRecipes<T extends RecipeListItem>(recipes: T[], query: string): T[] {
...
export function useRecipeSearch<T extends RecipeListItem>(recipes: T[], query: string): T[] {
