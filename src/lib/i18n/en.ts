...
export const en: Dictionary = {
  ...
  tagNames: {
    ...
    Œufs: "Eggs",
    "Tofu / Protéines végétales": "Tofu / Plant proteins",
    Légumineuses: "Legumes",
    Française: "French",
    Italienne: "Italian",
    Indienne: "Indian",
    "Libanaise / Orientale": "Lebanese / Middle Eastern",
    Mexicaine: "Mexican",
    Asiatique: "Asian",
    Africaine: "African",
    Américaine: "American",
    ...
    Nordique: "Nordic",
    Rapide: "Quick",
    "En batch": "Batch cooking",
    "Repas de fête": "Holiday meal",
    "Pique-nique": "Picnic",
    Lunchbox: "Lunchbox",
    "Pas cher": "Budget-friendly",
    Facile: "Easy",
    "One-pot": "One-pot",
    "Sans cuisson": "No-cook",
    "Pour les enfants": "Kid-friendly",
    "À congeler": "Freezer-friendly",
  },
  ...
  import: {
    ...
    errorSiteBlocked: "This site blocks automated access. Try a screenshot or type it in manually.",
  ...
  join: {
    ...
    enterBody:
      "Ask a member of the cookbook for their invite code. You'll get instant access to the shared recipes.",
  },
  ...
  household: {
    ...
    createBody:
      "A cookbook to share with the people close to you. Your recipes end up together, in one place.",
    ...
    deleteConfirmBody:
      "All the recipes in this cookbook and every device's access will be deleted.",
  ...
  profile: {
    ...
    logoutConfirmBody:
      "This device will be logged out. You can get your cookbooks back with your recovery email.",
