...
import { assembleV3, type CarnetRow, type DailyRow, type DemoRow, type HealthRow, type RawV3, type SharingRow, type WeeklyActiveRow, type WeeklyRecipesRow } from "@/lib/admin/v3/assemble";
...
export async function loadRawV3(now: Date = new Date()): Promise<RawV3> {
  ...
  const [people, weeklyActive, weeklyRecipes, demo, healthRows, sharingRows, carnets, daily, appStore, billedUsd] = await Promise.all([
