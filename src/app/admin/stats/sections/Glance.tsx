    ...
    <>
      ...
      <div className="section">
        <SectionHead
          ...
          q={`Dernière semaine close (${o.weekLabel}) vs les 4 précédentes · le même contenu part chaque lundi par e-mail`}
        />
        <div className="glance">
          <div className="north">
            ...
            <div className="sub">
              dont <b>{o.northStar.engaged}</b> ont ajouté ou consulté une recette ·{" "}
              {o.northStar.total} personnes au total{" "}
              <span
                className="tag"
                title="v1 = a ouvert l'app ; la consultation est comptée depuis le 13 sept. 2026 (lot B)"
              >
                v1 = a ouvert l&apos;app
              </span>
            </div>
            ...
            <div className="note">
              12 semaines closes · un point = personnes actives sur les 28 jours qui précèdent le
              dimanche
            </div>
          </div>
          <div>
