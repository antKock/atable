...
import { SectionHead, Card, Funnel, BarRow, BigStats, RatioText, Legend } from "@/components/admin/AdminUi";
import { StackedWeekly, StoreRates } from "@/components/admin/Charts";
import type { DashboardV3 } from "@/lib/admin/v3/assemble";

export default function Acquire({ acq, engage }: { acq: DashboardV3["acquisition"]; engage: DashboardV3["engage"] }) {
  return (
    <>
    {/* ============ 2 · ACQUÉRIR ============ */}
